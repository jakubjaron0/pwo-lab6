...
public enum SeqType {
    ...
    /**
     *Ciąg Fibonacciego
     * @see <a href="https://pl.wikipedia.org/wiki/i%C4%85g_Fibonacciego">Wikipedia</a>
     */
    FIB, //Fibonacci
 ...
 * Tylko 3 pierwsze litery słowa są znaczące.
     * @param type type W obecnej wersji: "fib", "luc" lub "tri"
     * @return  dpowiadająca argumentowi wartość typu lub null
     */
